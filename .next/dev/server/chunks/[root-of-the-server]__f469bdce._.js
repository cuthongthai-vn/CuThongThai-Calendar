...
"[project]/app/api/events/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    ...
    try {
        ...
        const { data, error } = await supabase.from('economic_events').update(body).eq('id', id).select();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f469bdce._.js.map