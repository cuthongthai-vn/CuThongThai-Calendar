...
function MacroChart({ data, title, dataKeys = [
    ...
    const allValues = filteredData.flatMap((d)=>activeKeys.map((k)=>d[k.key])).filter((v)=>v !== undefined && v !== null);
    // Auto-scale or default
    const minVal = allValues.length ? Math.min(...allValues) * 0.95 : 0;
    const maxVal = allValues.length ? Math.max(...allValues) * 1.05 : 100;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=components_MacroChart_1963b13b.js.map